...
variable "aks_cluster_name" {
  ...
  default     = "Aks-FullStackApp-Challenge"
  type        = string
}
...
variable "tags" {
  ...
  default     = {
    createdWith = "ChallengeApi-AKS-Cluster"
  }
}
...
variable "email" {
  ...
  type = string
  default = "rodrigomorocloud@outlook.com"
}
